...
interface ThunderhorseStackProps extends StackProps {
...
export class ThunderhorseStack extends Stack {
  constructor(scope: Construct, id: string, props: ThunderhorseStackProps) {
    ...
    taskDefinition.addVolume({
      name: `${props.appName}-${props.environment}-app-logs`,
    });
    ...
    appContainer.addMountPoints({
      containerPath: "/home/app/var/log/Perl/dist/App-Schierer-HPFan",
      sourceVolume: `${props.appName}-${props.environment}-app-logs`,
      readOnly: false,
    });
